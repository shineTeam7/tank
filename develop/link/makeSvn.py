...
if __name__ == '__main__':
	...
	add('develop/server/toolsGame --depth empty')
	ignore(['preJar'], 'develop/server/toolsGame')
	add('develop/server/toolsGame --force')
	...
	#laya
		...
		add('develop/client/game/bin --depth empty')
		ignore(['js'], 'develop/client/game/bin')

		add('develop/client/game/src --depth empty')

		ignore(['shine',
				'commonGame'
				], 'develop/client/game/src')
	...
	if eType==0:
		...
		externals(['/clientLaya/game/src/shine shine',
				   '/clientLaya/game/src/commonGame commonGame'], 'develop/client/game/src', corePath)
