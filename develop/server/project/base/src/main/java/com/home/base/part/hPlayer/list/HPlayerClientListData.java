...
public class HPlayerClientListData extends GPlayerClientListData
{
	/** 数据类型ID */
	public static final int dataID=HPlayerListClientDataType.HPlayer;
	
	public HPlayerClientListData()
	{
		_dataID=HPlayerListClientDataType.HPlayer;
	}
	...
	{
		if(!(data instanceof HPlayerClientListData))
			return;
		
		HPlayerClientListData mData=(HPlayerClientListData)data;
