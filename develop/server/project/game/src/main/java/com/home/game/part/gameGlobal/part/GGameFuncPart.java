...
/** (generated by shine) */
public class GGameFuncPart extends GameFuncPart
{
	/** 角色对象 */
	public GGameGlobal gme;
	
	/** 数据 */
	private GGameFuncPartData _d;
	...
	public void setData(BaseData data)
	{
		...
		_d=(GGameFuncPartData)data;
	}
	
	/** 获取数据 */
	public GGameFuncPartData getGPartData()
	{
		return _d;
	}
	...
	public void construct()
	{
		...
		//大乱斗
		me.func.registFuncTool(new GameToCenterMatchTool(GFunctionType.Melee)
		{
			@Override
			...
			{
				super.doMatchTimeOut(player);
				
				//自由一次
				((GPlayer)player).gscene.clientFreeMeleeOnce();
			}
		});
	}
