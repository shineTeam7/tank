...
/** 功能(generated by shine) */
public class GFuncPart extends FuncPart
{
	/** 角色对象 */
	public GPlayer gme;
	
	/** 数据 */
	private GFuncPartData _d;
	...
	public void setData(BaseData data)
	{
		...
		_d=(GFuncPartData)data;
	}
	
	/** 获取数据 */
	public GFuncPartData getGPartData()
	{
		return _d;
	}
	...
	protected void writeClientData(BaseClientPartData data)
	{
		...
		toWriteClientData((GFuncClientPartData)data);
	}
	
	/** 写客户端数据具体执行(已执行过copyServer了,就是说CPO中与SPO同名同类型的属性无需再赋值) */
	private void toWriteClientData(GFuncClientPartData data)
	{
