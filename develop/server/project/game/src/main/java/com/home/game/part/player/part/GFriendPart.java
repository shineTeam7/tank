...
public class GFriendPart extends FriendPart
{
	...
	/** 获取数据 */
	public GFriendPartData getGPartData()
	{
		return _d;
	}
	...
	protected void writeClientData(BaseClientPartData data)
	{
		...
		toWriteClientData((GFriendClientPartData)data);
	}
	
	/** 写客户端数据具体执行(已执行过copyServer了,就是说CPO中与SPO同名同类型的属性无需再赋值) */
	private void toWriteClientData(GFriendClientPartData data)
	{
