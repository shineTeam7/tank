...
import com.home.commonGame.part.player.part.SingleBagPart;
import com.home.game.part.player.GPlayer;
import com.home.shine.data.BaseData;

/** 背包(generated by shine) */
public class GBagPart extends SingleBagPart
{
	/** 角色对象 */
	public GPlayer gme;
	
	/** 数据 */
	private GBagPartData _d;
	...
	public void setData(BaseData data)
	{
		...
		_d=(GBagPartData)data;
	}
	
	/** 获取数据 */
	public GBagPartData getGPartData()
	{
		return _d;
	}
	...
	protected void writeClientData(BaseClientPartData data)
	{
		...
		toWriteClientData((GBagClientPartData)data);
	}
	
	/** 写客户端数据具体执行(已执行过copyServer了,就是说CPO中与SPO同名同类型的属性无需再赋值) */
	private void toWriteClientData(GBagClientPartData data)
	{
