...
public class GUnionPart extends UnionPart
{
	...
	public void setData(BaseData data)
	{
		...
		_d=(GUnionPartData)data;
	}
	
	/** 获取数据 */
	public GUnionPartData getGPartData()
	{
		return _d;
	}
	...
	protected void writeClientData(BaseClientPartData data)
	{
		...
		toWriteClientData((GUnionClientPartData)data);
	}
	
	/** 写客户端数据具体执行(已执行过copyServer了,就是说CPO中与SPO同名同类型的属性无需再赋值) */
	private void toWriteClientData(GUnionClientPartData data)
	{
