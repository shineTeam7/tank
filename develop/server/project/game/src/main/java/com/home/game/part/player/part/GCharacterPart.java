...
import com.home.commonGame.part.player.part.SingleCharacterPart;
import com.home.game.part.player.GPlayer;
import com.home.shine.data.BaseData;

/** 角色(generated by shine) */
public class GCharacterPart extends SingleCharacterPart
{
	/** 角色对象 */
	public GPlayer gme;
	
	/** 数据 */
	private GCharacterPartData _d;
	...
	/** 获取数据 */
	public GCharacterPartData getGPartData()
	{
		return _d;
	}
	...
	protected void writeClientData(BaseClientPartData data)
	{
		...
		toWriteClientData((GCharacterClientPartData)data);
	}
	
	/** 写客户端数据具体执行(已执行过copyServer了,就是说CPO中与SPO同名同类型的属性无需再赋值) */
	private void toWriteClientData(GCharacterClientPartData data)
	{
