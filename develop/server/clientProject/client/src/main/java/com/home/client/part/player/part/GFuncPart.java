...
import com.home.commonClient.tool.func.PlayerAuctionTool;
...
public class GFuncPart extends FuncPart
{
	...
	/** 数据 */
	private GFuncClientPartData _d;
	...
	public void setData(BaseData data)
	{
		...
		_d=(GFuncClientPartData)data;
	}
	
	/** 获取数据 */
	public GFuncClientPartData getGPartData()
	{
		return _d;
	}
